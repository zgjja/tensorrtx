...
static auto addRelu6(INetworkDefinition* network, WeightMap& weight_map, ITensor& input, const std::string& name)
        -> ILayer* {
...
static auto addLinear(INetworkDefinition* network, WeightMap& weight_map, ITensor& input, const std::string& weight_key,
                      const std::string& bias_key, int32_t in_features, int32_t out_features, const std::string& name)
        -> ILayer* {
...
static auto addV2Block(INetworkDefinition* network, WeightMap& weight_map, ITensor& input, const V2BlockParams& params)
        -> ILayer* {
...
static auto addV3Block(INetworkDefinition* network, WeightMap& weight_map, ITensor& input, const V3BlockParams& params)
        -> ILayer* {
...
static auto doInference(IExecutionContext& context, void* input, int64_t batch_size)
